...
CASES = "output/input_covid_matched_cases_contemporary_allSTPs_omicron.csv"

# Import Variables 
## outcome variables (note, relative to community COVID19 case (index) date)
from outcome_variables_symp_contemporary_omicron import generate_outcome_variables_symp_contemporary_omicron
outcome_variables_symp_contemporary_omicron = generate_outcome_variables_symp_contemporary_omicron(index_date_variable="case_index_date")
...
study = StudyDefinition(
    ...
    **outcome_variables_symp_contemporary_omicron,  
