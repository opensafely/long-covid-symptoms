...
capture log close
log using ./logs/13cc_longCovidBNFTimePeriods_countsPerGroupcontemporary_omicron.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure2PanelC_countsPerGroup_contemporary_omicron.txt, t w replace
