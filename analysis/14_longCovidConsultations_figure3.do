...
file write tablecontents "Fig 3: Median consultations overall and over time for `dataset' comparator population (overall and by prev consultation rate strata)" _n _n
