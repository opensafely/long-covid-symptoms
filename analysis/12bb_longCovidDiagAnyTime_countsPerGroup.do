...
capture log close
log using ./logs/12bb_longCovidDiagAnyTime_countsPerGroup`dataset'.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure1PanelB_countsPerGroup_`dataset'.txt, t w replace
