...
capture log close
log using ./logs/12b_longCovidDiagAnyTime_figure1PanelBcontemporary.log, replace t
...
file open tablecontents using ./output/figure1PanelB_longCovidDiagAnyTime_contemporary.txt, t w replace
