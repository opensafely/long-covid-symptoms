...
capture log close
log using ./logs/17_longCovidBNFAnyTime_gpConsInteractioncontemporary_omicron.log, replace t
...
file open tablecontents using ./output/Figure6_gpConsInteraction_contemporary_omicron.txt, t w replace
file write tablecontents "Fig 6: Analysis of prescriptions (at any time) including interaction with prev cons for contemporary_omicron comparator population (full adjusted)" _n _n
file write tablecontents ("Prescription") _tab ("Prev GP consults") _tab ("OR (95% CI)") _n
