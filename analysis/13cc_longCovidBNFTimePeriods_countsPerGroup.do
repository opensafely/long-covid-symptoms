...
capture log close
log using ./logs/13cc_longCovidBNFTimePeriods_countsPerGroup`dataset'.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure2PanelC_countsPerGroup_`dataset'.txt, t w replace
