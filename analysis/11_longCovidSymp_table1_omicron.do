...
capture log close
log using ./logs/11_longCovidSymp_table1contemporary_omicron.log, replace t
...
file open tablecontent using ./output/table1_longCovidSymp_contemporary_omicron.txt, write text replace

file write tablecontent ("Table 1: Demographic and clinical characteristics for exposed to COVID-19 and contemporary_omicron matched unexposed") _n
...
*Prescribing (number of distinct bnf categories of prescribing - 3 categories)
tab numPrescTypesPrevYearCat case, col
tabulatevariable, variable(numPrescTypesPrevYearCat) min(0) max(2) 
file write tablecontent _n 

*Previous consultations (3 categories)
tab gpCountPrevYearCat case, col
tabulatevariable, variable(gpCountPrevYearCat) min(0) max(2) 
file write tablecontent _n 
