...
capture log close
log using ./logs/17_longCovidBNFAnyTime_gpConsInteraction`dataset'.log, replace t
...
file open tablecontents using ./output/Figure6_gpConsInteraction_`dataset'.txt, t w replace
file write tablecontents "Fig 6: Analysis of prescriptions (at any time) including interaction with prev cons for `dataset' comparator population (full adjusted)" _n _n
