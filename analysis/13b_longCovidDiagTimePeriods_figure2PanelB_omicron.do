...
capture log close
log using ./logs/13b_longCovidDiagTimePeriods_figure2PanelBcontemporary_omicron.log, replace t
...
prog define outputORsforOutcomePreg
	*`1'=outcome, `2'=dataset
...
file open tablecontents using ./output/figure2PanelB_longCovidDiagTimePeriods_contemporary_omicron.txt, t w replace
...
cap noisily outputORsforOutcomePreg pregnancy_compl contemporary_omicron
file write tablecontents _n
