...
cap log close
log using ./logs/07_set_correct_death_dates_historical_wAllVars.log, replace t
...
import delimited ./output/input_complete_controls_`1'.csv, clear 
...
*save file
capture noisily export delimited using "./output/input_complete_controls_historicalCorrectedDeathDate.csv", replace
