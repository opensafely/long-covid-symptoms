...
def generate_outcome_variables_medicines_contemporary(index_date_variable):
    outcome_variables_medicines_contemporary = dict(
...
# TIME PERIOD THREE (T3): 6 MONTHS - 12 MONTHS
    ...
    return outcome_variables_medicines_contemporary