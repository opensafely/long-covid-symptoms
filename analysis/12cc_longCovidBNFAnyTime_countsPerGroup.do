...
capture log close
log using ./logs/12cc_longCovidBNFAnyTime_countsPerGroup`dataset'.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure1PanelC_countsPerGroup_`dataset'.txt, t w replace
