...
log using ./logs/20_GP_consultationsPostCOVID_omicron.log, replace t
...
file open tablecontent using ./output/consultationsPostCOVID_longCovidSymp_omicron.csv, write text replace
