...
capture log close
log using ./logs/12a_longCovidSympAnyTime_figure1PanelAcontemporary_omicron.log, replace t
...
file open tablecontents using ./output/figure1PanelA_longCovidSympAnyTime_contemporary_omicron.txt, t w replace
file write tablecontents "Fig 1: Panel A. Community COVID-19: Odds ratios comparing odds of post-COVID SYMPTOMS AT ANY TIME during follow up in community COVID-19 compared to contemporary_omicron" _n _n
...
/*not needed as all these are in the main syptom analysis
