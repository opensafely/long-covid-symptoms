/*=========================================================================
DO FILE NAME:			covidSxs-codelist24-tinnitus
...
DESCRIPTION OF FILE:	Aim: identify SNOMED codes for tinnitus
						 				
MORE INFORMATION:	
					
DATASETS USED:		snomedct.csv // all snomed codes supplied by Peter Inglesby

DATASETS CREATED: 	snomed-tinnitus-working
...
global filename "covidSxs-codelist24-tinnitus"
...
#1. Define search terms
	...
	- run search
*******************************************************************************/
local searchterm " "*tinnitus*" "*ringing*" "*buzzing*" "*hissing*" "*roaring*" "
local searchterm " `searchterm' "*hearing nois*" "
...
*******************************************************************************/
* define exclusions
local exterm " "*syring*" "*fallopian*" "*wringing*" "
local exterm " `exterm' "fh:*" "family history*" "history of*" "h/o*" "
local exterm " `exterm' "*bowstring*" "*no tinnitus*" "*upbringing*" "
local exterm " `exterm' "*heart*" "*springing*" "*stringing*" "*respiration*" "
...
* save in csv format
export delimited using "../codelists/working/snomed-tinnitus-working.csv", replace novarnames
