...
from outcome_variables_medicines_contemporary import generate_outcome_variables_medicines_contemporary
outcome_variables_medicines_contemporary = generate_outcome_variables_medicines_contemporary(index_date_variable="case_index_date")
...
study = StudyDefinition(
    ...
    **outcome_variables_medicines_contemporary,  
