...
* Open a log file
cap log close
log using ./logs/6a_longCovidSymp_checkCombinedFiles.log, replace t




*(0)=========Cases============
import delimited ./output/input_covid_matched_cases_allSTPs.csv, clear
...
*(0)=========Controls============
import delimited ./output/input_covid_matched_matches_allSTPs.csv, clear
