...
* Open a log file
cap log close
log using ./logs/01b_longCovidSymp_splitHistorical_by_stp.log, replace t



*(1)=========Split historical comparators into separate stp files============
...
foreach i of numlist 5/9  {
	preserve
		...
		capture noisily export delimited using "./output/input_controls_historical_stp`i'.csv", replace
		count
