...
capture log close
log using ./logs/12bb_longCovidDiagAnyTime_countsPerGroupcontemporary_omicron.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure1PanelB_countsPerGroup_contemporary_omicron.txt, t w replace
...
cap noisily outputCountsforOutcome, outcome(tEver_pregnancy_compl)
file write tablecontents _n
