...
capture log close
log using ./logs/13bb_longCovidDiagTimePeriods_countsPerGroupcontemporary_omicron.log, replace t
...
prog define outputCountsforOutcomePreg
	*`1'=outcome, `2'=dataset)
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure2PanelB_countsPerGroup_contemporary_omicron.txt, t w replace
...
*pregnancy
keep if age>=15 & age<=45
cap noisily outputCountsforOutcomePreg pregnancy_compl contemporary_omicron
file write tablecontents _n
