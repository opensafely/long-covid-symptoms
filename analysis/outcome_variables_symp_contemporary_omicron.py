...
def generate_outcome_variables_symp_contemporary_omicron(index_date_variable):
    outcome_variables_symp_contemporary_omicron = dict(
...
#opensafely/symptoms-mobility-impairment/62a81387
    ...
    t3_symp_breathless=patients.with_these_clinical_events(
        breathless_symptom_codes,
        between=[f"{index_date_variable} + 181 days", "2023-03-31"], #Latest follow-up date post-omicron
        returning="binary_flag", 
        return_expectations={"incidence": 0.15},
    ), 
    ...
    return outcome_variables_symp_contemporary_omicron