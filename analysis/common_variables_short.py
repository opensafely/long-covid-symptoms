# currently copied from here: https://github.com/opensafely/post-covid-outcomes-research/blob/main/analysis/common_variables.py
# need to edit appropriately for common vars needed by my study
