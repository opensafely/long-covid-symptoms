...
capture log close
log using ./logs/12cc_longCovidBNFAnyTime_countsPerGroupcontemporary_omicron.log, replace t
...
count if expStatus==1
local totExp=r(N)
file open tablecontents using ./output/figure1PanelC_countsPerGroup_contemporary_omicron.txt, t w replace
