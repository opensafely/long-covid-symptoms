...
capture log close
log using ./logs/16_longCovidDiagAnyTime_gpConsInteractioncontemporary_omicron.log, replace t
...
file open tablecontents using ./output/Figure5_gpConsInteraction_contemporary_omicron.txt, t w replace
file write tablecontents "Fig 5: Analysis of diagnoses (at any time) including interaction with prev consultations for contemporary_omicron comparator population (full adjusted)" _n _n
...
file write tablecontents "****Fig 5 sensitivity: Same as above but with people with no consultations dropped, and lowest consultation group has 1 consultation****" _n _n
use ./output/longCovidSymp_analysis_dataset_contemporary_omicron.dta, clear
rename case expStatus
